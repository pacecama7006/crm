                        ...
                        @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="contact_name" id="contact_name" class="form-control {{ $errors->has('contact_name') ? 'is-invalid' : '' }}" placeholder="Ingrese el nombre del contacto" value="{{ old('contact_name', '') }}">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="contact_phone_number" id="contact_phone_number" class="form-control {{ $errors->has('contact_phone_number') ? 'is-invalid' : '' }}" placeholder="Ingrese el nombre del contacto" value="{{ old('contact_phone_number', '') }}">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" name="contact_email" id="contact_email" class="form-control {{ $errors->has('contact_email') ? 'is-invalid' : '' }}" placeholder="Ingrese el email del contacto" value="{{ old('contact_email', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="company_adress" id="company_adress" class="form-control {{ $errors->has('company_adress') ? 'is-invalid' : '' }}" placeholder="Ingrese la dirección de la empresa" value="{{ old('company_adress', '') }}">
